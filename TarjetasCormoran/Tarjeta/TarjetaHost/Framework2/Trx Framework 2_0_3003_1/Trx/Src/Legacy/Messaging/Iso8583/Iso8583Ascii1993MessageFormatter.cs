    ...
    public class Iso8583Ascii1993MessageFormatter : Iso8583MessageFormatter
    {
        ...
        private void SetupFields()
        {
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                ...
                DataEncoder.GetInstance(), "Track 2 data"));
            FieldFormatters.Add(new StringFieldFormatter(
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                ...
                "Approval code"));
            FieldFormatters.Add(new StringFieldFormatter(
                39, new FixedLengthManager(3), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new BinaryFieldFormatter(
                52, new FixedLengthManager(8), HexDataEncoder.GetInstance(),
                "Personal identification number (PIN) data"));
            FieldFormatters.Add(new BinaryFieldFormatter(
                53, new VariableLengthManager(0, 48, StringLengthEncoder.GetInstance(48)),
                HexDataEncoder.GetInstance(), "Security related control information"));
            FieldFormatters.Add(new StringFieldFormatter(
            ...
            FieldFormatters.Add(new BinaryFieldFormatter(
                ...
                HexDataEncoder.GetInstance(), "IC card system related data"));
            FieldFormatters.Add(new StringFieldFormatter(
                56, new VariableLengthManager(0, 35, StringLengthEncoder.GetInstance(35)),
                DataEncoder.GetInstance(), NumericValidator.GetInstance(),
                "Original data elements"));
            FieldFormatters.Add(new StringFieldFormatter(
                57, new FixedLengthManager(3), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new BinaryFieldFormatter(
                96, new VariableLengthManager(0, 999, StringLengthEncoder.GetInstance(999)),
                HexDataEncoder.GetInstance(), "Key management data"));
            FieldFormatters.Add(new StringFieldFormatter(
                97, new FixedLengthManager(17), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                105, new FixedLengthManager(16), DataEncoder.GetInstance(),
                ZeroPaddingLeft.GetInstance(false, true), "Credits, chargeback amount"));
            FieldFormatters.Add(new StringFieldFormatter(
                106, new FixedLengthManager(16), DataEncoder.GetInstance(),
                ZeroPaddingLeft.GetInstance(false, true), "Debits, chargeback amount"));
            FieldFormatters.Add(new StringFieldFormatter(
                107, new FixedLengthManager(10), DataEncoder.GetInstance(),
                ZeroPaddingLeft.GetInstance(false, true), "Credits, chargeback number"));
            FieldFormatters.Add(new StringFieldFormatter(
                108, new FixedLengthManager(10), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                ...
                DataEncoder.GetInstance(), "Reserved for private use"));
            FieldFormatters.Add(new BinaryFieldFormatter(
                128, new FixedLengthManager(8), HexDataEncoder.GetInstance(),
        ...
        {
            var formatter = new Iso8583Ascii1993MessageFormatter();
