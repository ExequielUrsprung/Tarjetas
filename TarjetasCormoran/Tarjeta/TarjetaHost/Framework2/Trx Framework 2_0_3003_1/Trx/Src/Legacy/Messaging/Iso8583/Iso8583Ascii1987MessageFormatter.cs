...
namespace Trx.Messaging.Iso8583
{
    ...
    public class Iso8583Ascii1987MessageFormatter : Iso8583MessageFormatter
    {
        ...
        private void SetupFields()
        {
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                12, new FixedLengthManager(6), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                15, new FixedLengthManager(4), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                22, new FixedLengthManager(3), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                25, new FixedLengthManager(2), DataEncoder.GetInstance(),
                ZeroPaddingLeft.GetInstance(false, false), "Point of service condition code"));
            FieldFormatters.Add(new StringFieldFormatter(
                26, new FixedLengthManager(2), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                28, new FixedLengthManager(9), DataEncoder.GetInstance(),
                ZeroPaddingLeft.GetInstance(false, true), "Transaction fee amount"));
            FieldFormatters.Add(new StringFieldFormatter(
                29, new FixedLengthManager(9), DataEncoder.GetInstance(),
                ZeroPaddingLeft.GetInstance(false, true), "Settlement fee amount"));
            FieldFormatters.Add(new StringFieldFormatter(
                30, new FixedLengthManager(9), DataEncoder.GetInstance(),
                ZeroPaddingLeft.GetInstance(false, true), "Transaction processing fee amount"));
            FieldFormatters.Add(new StringFieldFormatter(
                31, new FixedLengthManager(9), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                53, new FixedLengthManager(16), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                66, new FixedLengthManager(1), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                71, new FixedLengthManager(4), DataEncoder.GetInstance(),
                ZeroPaddingLeft.GetInstance(false, true), "Message number"));
            FieldFormatters.Add(new StringFieldFormatter(
                72, new FixedLengthManager(4), DataEncoder.GetInstance(),
            ...
            FieldFormatters.Add(new StringFieldFormatter(
                ...
                "Replacement amounts"));
            FieldFormatters.Add(new BinaryFieldFormatter(
                96, new FixedLengthManager(16), HexDataEncoder.GetInstance(),
        ...
        {
            var formatter = new Iso8583Ascii1987MessageFormatter();
