...
{
    /// <summary>
    /// Represents errors that occur in Trx services.
    /// </summary>
    [Serializable]
    public class TrxServiceException : ApplicationException
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public TrxServiceException()
        {
        }
        ...
        /// </param>
        public TrxServiceException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        public TrxServiceException(Exception innerException) :
        ...
        /// exception is raised in a catch block that handles the inner exception.
        /// </param>
        public TrxServiceException(string message, Exception innerException) :
        ...
        /// </param>
        protected TrxServiceException(SerializationInfo info, StreamingContext context) :
            base(info, context)
        {
        }
    }
