...
{
    public class DeflateStringFieldFormatter : StringFieldFormatter
    {
        /// <summary>
        ...
        /// </param>
        public DeflateStringFieldFormatter(int fieldNumber, LengthManager lengthManager, IDataEncoder encoder)
        ...
        /// </param>
        public DeflateStringFieldFormatter(int fieldNumber, LengthManager lengthManager, IDataEncoder encoder,
            string description) : base(fieldNumber, lengthManager, encoder, description)
        {
        }
        ...
        /// </param>
        public DeflateStringFieldFormatter(int fieldNumber, LengthManager lengthManager, IDataEncoder encoder,
            IStringPadding padding) : base(fieldNumber, lengthManager, encoder, padding)
        {
        }
        ...
        /// </param>
        public DeflateStringFieldFormatter(int fieldNumber, LengthManager lengthManager, IDataEncoder encoder,
            IStringValidator validator) : base(fieldNumber, lengthManager, encoder, validator)
        {
        }
