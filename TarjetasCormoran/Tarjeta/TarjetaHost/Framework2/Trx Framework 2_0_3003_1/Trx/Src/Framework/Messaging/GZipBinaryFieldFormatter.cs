...
{
    public class GZipBinaryFieldFormatter : BinaryFieldFormatter
    {
        /// <summary>
        ...
        /// </param>
        public GZipBinaryFieldFormatter(int fieldNumber, LengthManager lengthManager, IDataEncoder encoder)
