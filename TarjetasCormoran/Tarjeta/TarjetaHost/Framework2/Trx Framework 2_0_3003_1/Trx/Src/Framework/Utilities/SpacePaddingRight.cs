...
namespace Trx.Utilities
{
    ...
    {
        private static volatile SpacePaddingRight _instanceWithTruncate;
        private static volatile SpacePaddingRight _instanceWithoutTruncate;
        ...
        {
            SpacePaddingRight instance = truncate ? _instanceWithTruncate : _instanceWithoutTruncate;
