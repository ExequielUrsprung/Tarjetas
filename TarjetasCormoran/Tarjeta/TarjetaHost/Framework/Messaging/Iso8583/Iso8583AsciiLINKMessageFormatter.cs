...
//
// Adaptacion de Gustavo Marzioni para LINK
//
#endregion
...
namespace Trx.Messaging.Iso8583 {
    ...
    /// ISO 8583-93.
    /// </summary>
    public class Iso8583AsciiLINKMessageFormatter : Iso8583MessageFormatter {

        #region Constructors
        /// <summary>
        /// It initializes a new ISO 8583 formatter.
        /// </summary>
        public Iso8583AsciiLINKMessageFormatter()
            : base() {
    ...
    ZeroPaddingLeft.GetInstance(false, true), "Message type identifier");
            ...
            FieldFormatters.Add(new StringFieldFormatter(
    41, new FixedLengthManager(16), StringEncoder.GetInstance(),
    "Card acceptor terminal identification"));
        ...
        public override object Clone() {
            ...
            Iso8583AsciiLINKMessageFormatter formatter = new Iso8583AsciiLINKMessageFormatter();
