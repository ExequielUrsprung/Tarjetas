...
Public Class ClientePeerLlamador
    Inherits ClientPeer

    Public Shared PuertoPosnet As Integer = 12345
    Public Shared IpPosnet As String = "127.0.0.1"
    ...
    Sub New(ByVal Nombre As String, ByVal Implementacion As E_Implementaciones, ByVal Hostname As String, ByVal POrt As Int32)
        MyBase.New(Nombre, _
                        ObtenerTcpChannel(Implementacion, Hostname, POrt), New BasicMessageIdentifierPOS())
        _hostname = Hostname
        _port = POrt
        _nombre = Nombre
