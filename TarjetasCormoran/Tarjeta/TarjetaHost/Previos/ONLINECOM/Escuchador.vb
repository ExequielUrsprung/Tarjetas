...
#End Region
    ...
    Public Sub ProcesarMensaje(ByVal m As Message, ByVal messageSource As IMessageSource)
        ...
        If Demora.TotalSeconds > My.Settings.DemoraMaxima Then
            Logger.Warn("Respuesta demoró " + Demora.ToString + " (demasiado)")
